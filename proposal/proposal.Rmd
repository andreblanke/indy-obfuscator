...
`getstatic`, and `putstatic`) may be included in the obfuscation effort by introducing additional method invocations,
as mentioned in the future works section of the research paper.
...
<!-- TODO: Elaborate on obfuscation passes -->
